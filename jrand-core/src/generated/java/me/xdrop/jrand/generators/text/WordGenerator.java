...
public class WordGenerator extends Generator<String> {
    ...
    @Generated("me.xdrop.jrand.annotation.processing.ForkClassGenerator")
    private WordGenerator(NaturalGenerator nat, SyllableGenerator syl, boolean capitalize,
            int syllablesMin, int syllablesMax, int length) {
        this.nat = nat;
        this.syl = syl;
        this.capitalize = capitalize;
        this.syllablesMin = syllablesMin;
        this.syllablesMax = syllablesMax;
        this.length = length;
    }
}
