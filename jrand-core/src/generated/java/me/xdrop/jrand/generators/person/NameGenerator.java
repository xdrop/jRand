...
public class NameGenerator extends Generator<String> {
    ...
    @Generated("me.xdrop.jrand.annotation.processing.ForkClassGenerator")
    private NameGenerator(LastnameGenerator last, FirstnameGenerator first, PrefixGenerator prefix,
            boolean reverseOrder, boolean withMiddleName, boolean withPrefix, boolean asCardName,
            Gender gender, String separator) {
        this.last = last;
        this.first = first;
        this.prefix = prefix;
        this.reverseOrder = reverseOrder;
        this.withMiddleName = withMiddleName;
        this.withPrefix = withPrefix;
        this.asCardName = asCardName;
        this.gender = gender;
